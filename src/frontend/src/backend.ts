...
export class Backend implements backendInterface {
    ...
    async addDisease(arg0: DiseaseInfo): Promise<void> {
    ...
    async predictDiseases(arg0: Array<string>): Promise<Array<PredictionResult>> {
        if (this.processError) {
            try {
                const result = await this.actor.predictDiseases(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
